...
public class TwoPlayerCategoryScreen extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        CategoryInfo.setText( "2 Player Mode Rules - Player 1 will enter their guess, then player 2 will enter theirs. Scores are revealed after each question. Highest score at the end of the match wins!" + "NOTE: More Categories will be added in future updates. " );
